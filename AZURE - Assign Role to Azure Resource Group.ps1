...
# Type: New Service
#
# Title: AZURE - Assign Role to Azure Resource Group
#
# v 1.0 Initial Release
#
#
# Init Release: 30.05.2022
# Last Update: 30.05.2022
# Code Template V 1.4
#
# URL: 
# Github: https://github.com/au2mator/AZURE-Assign-Azure-Role-in-Resource-Group
#################
...
[string]$LogfileName = "AZURE - Assign Role to Azure Resource Group"

[string]$CredentialStorePath = "C:\_SCOworkingDir\TFS\PS-Services\CredentialStore" #see for details: https://au2mator.com/documentation/powershell-credentials/?utm_source=github&utm_medium=social&utm_campaign=AZURE_AssignResourceGroupRole&utm_content=PS1
...
# Stored Credentials
# See: https://au2mator.com/documentation/powershell-credentials/?utm_source=github&utm_medium=social&utm_campaign=AZURE_AssignResourceGroupRole&utm_content=PS1
...
#TeamsCredentials to send Teams Card #https://au2mator.com/documentation/powershell-credentials/?utm_source=github&utm_medium=social&utm_campaign=AZURE_AssignResourceGroupRole&utm_content=PS1
...
try {
    ...
    try {
        ...
        try {
            Write-au2matorLog -Type INFO -Text "Try to assign Azure Role"
            ...
            #Assign Role
            $URL = "https://management.azure.com/subscriptions/$c_subscription/resourceGroups/$c_ResourceGroup/providers/Microsoft.Authorization/roleAssignments/$($GUID)?api-version=$apiversionRole"
            $bodyRole = @"
                { "properties": {
                    "roleDefinitionId":"$($roles.value.id)",
                    "principalId":"$($ResultUser.id)"
                }
                }
"@
